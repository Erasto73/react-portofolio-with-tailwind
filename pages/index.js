...
import deved from "../public/Erasto.png";
...
export default function Home() {
  ...
  return (
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">developedbyEK</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <h3 className="text-2xl py-2 dark:text-white md:text-3xl">
              Telecommunication Engineer and Front end Developer.
            </h3>
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              Specialize in creating engaging user interface and seamless user experiences that bring digital concepts to life.
              My expertise lies in transforming design mockups into interactive websites and applications using latest technologies:
        ...
        <><section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div>
              ...
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
                Worked with design, product and back end teams to create web products,
                create efficient and reuseable front end systems to drive web applications
                to the market place, participated in product releases and code reviews with
                team Leaders.
              </p>
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
    ...
    <div className="text-center p-10 py-10 text" >
     <Footer />
    </div>       
  </> 
);
